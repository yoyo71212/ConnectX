...
#         agent_thread.join()  # Wait a bit longer if needed
#         raise TimeoutError("Agent timed out.")
...
#         # Convert to numpy array of objects if needed
#         player_moves_array = np.array(player_moves, dtype=object)

#         # Print the result
#         print(player_moves_array)
...
def api_simulate_game():
    try:
        ...
        return jsonify(player_moves_array.tolist())
